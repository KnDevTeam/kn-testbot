...
❌ ни какого треш контента
❌ ни каких тем 18+ и пошлостей
❌ ни какого флуда стикерами
❌ ни какого флуда медиа
❌ ни каких портянок
❌ ни каких свадеб и сватовства
❌ ни каких сторонних ссылок
❌ ни какого срача. На все спорные ситуации вызываем админа @killnet_AntiBan, если ответа нет, то Шеф @Ev1LcheF , Яри  @Yary_koval либо ELEMENT  @lll0v0lll вопрос решат. 
