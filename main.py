...
RULES = '''
Правила чата KILLNET

Запрещается:
❌ треш контент, чрезмерная пошлость и темы 18+
❌ реклама своих и стороних продуктов, каналов, чатов, услуг.
❌ просьбы любой финансовой помощи донатов, оплаты своих услуг.
❌ флуд, включая злоупотребление стикерами и медиа.
❌ дискредитация СВО, власти, и оскорбление дружественных стран.
❌ оскорбление религиозных конфессий (признанных на территории РФ)
❌ пропаганда ЛГБТ
❌ размещение ссылок на сторонние сервисы.
❌ никаких портянок.
❌ никаких свадеб и сватовства.
❌ никакого срача. 

⚠️ игнорирование замечаний админа вызывает бан.

На все спорные ситуации вызываем админа @killnet_AntiBan , либо @Snake_ebet_xoxlov. 
Если ответа нет, то @Yary_koval либо @lll0v0lll помогут решить вашу проблему. 

Если вас снесли не мы, а кто-то из старшего начальства, разбан невозможен. Не нужно потом писать нам в лс. Думайте над поведением и словами сразу.
🇷🇺❤️🇷🇺
...
/help или /помощь - Эта команда вызывает меню помощи
...
@killnet_AntiBan @Snake_ebet_xoxlov @Yary_kova @lll0v0lll
